...
--
-- Host: localhost
-- Generation Time: Jan 23, 2010 at 10:47 AM
...
(2, 'Student Activities Funding Committee', 'safc', 1, 'The give people money.', 1, 'closed', NULL, 'http://bsg.bowdoin.edu/bsg/safc.php', '', NULL, 1, 0, 0, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL),
...
CREATE TABLE IF NOT EXISTS `positions_types` (
  ...
  `idorgs_categories` int(11) NOT NULL,
...
(1, 'Administrator', 'admin', 0, NULL, 'Administrator of this group''s BSO account.', 'appointed', 'admin', 'open', 'full'),
(2, 'Member', 'member', 0, NULL, 'Member of this group.', 'open', 'self', 'open', 'read'),
(3, 'President', 'pres', 0, 1, 'The BSG president does stuff.', 'election', 'students', 'open', 'semi'),
(4, 'Class President', 'class_pres', 1, NULL, 'The chief executive of a class.', 'election', 'class', 'class', 'read');
...
INSERT INTO `users` (`idusers`, `alias`, `fullname`, `nickname`, `classyear`, `major`, `bio`, `image`, `twitter`, `facebook`, `url`) VALUES
(1, 'ctucker', 'Christopher Tucker', 'Toph', 2012, 'Undecided', 'I love existence! <b>Woohoo!!!</b> Also, I think this whole web site thing is really shaping up quite nicely. And now you can kind of login!', NULL, 'tophtucker', 'tophtucker', 'http://www.tophtucker.com/'),
(2, 'wtucker', 'William Tucker', 'Willy', 2013, 'Videogames', 'I''m Toph''s brother.', NULL, '', 'willytucker', ''),
(3, 'awolf', 'Aaron Wolf', 'Aaron', 2012, 'Physics', 'I was Toph''s roommate last year.', NULL, '', '', ''),
(4, 'rshaw3', 'Robert Shaw', 'Bobby', 2012, 'Chemistry', 'I''m one of Toph''s current roommates!', NULL, '', 'bobby.shaw', ''),
(5, 'cli', 'Chris Li', 'Chris', 2011, 'Music', 'Worst. Proctor. Ever.', NULL, '', 'clibird', ''),
(6, 'asprauten', 'Anitra Sprauten', 'Anitra', 2012, 'French', 'I''m a Facebook unperson.', NULL, '', '', '');
